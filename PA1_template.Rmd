...
From these calculations, we can see that the mean total number of steps taken per day is `r mean_steps`, and the median total number of steps taken per day is `r median_steps`.
